...
create table if not exists user(
	...
	topic_number int(11) default null comment '发帖数',
	fans_number int(11) default null comment '粉丝数量',
	concern_number int(11) default null comment '关注数量',
...
create table if not exists topic(
	...
	view_times int(11) default null comment '浏览量',
	zan_times int(11) default null comment '点赞数',
	primary key (id)
);
...
create table if not exists reply(
	...
	agree_times int(11) default null comment '赞成数量',
	disagree_times int(11) default null comment '不赞成数量',
	primary key (id)
);
